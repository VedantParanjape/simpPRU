...
{
    // while(flag.wait_for(std::chrono::milliseconds(10)) == std::future_status::timeout)
    while(!stop_read_signal_)
    {
        char buffer[512];
        for (int i = 0; i < 512; i++)
        {
