...
%union{
    ...
    struct ast_node_bwa_assignment *bwa_assignment;
    struct ast_node_bwo_assignment *bwo_assignment;
...
%token OPR_BWA_ASSIGNMENT
%token OPR_BWO_ASSIGNMENT
...
%type <bwa_assignment> bwa_assignment
%type <bwo_assignment> bwo_assignment
...
statement: compound_statement {
         ...
         | bwa_assignment {
             $$ = create_statement_node(AST_NODE_BWA_ASSIGNMENT, (void*)$1);
         }
         | bwo_assignment {
             $$ = create_statement_node(AST_NODE_BWO_ASSIGNMENT, (void*)$1);
         }
         | array_assignment {
...
bwa_assignment: INT_IDENTIFIER OPR_BWA_ASSIGNMENT arithmetic_expression SEMICOLON {
               if ($1 == NULL)
               {
                   yyerror("variable already defined");
               }
            ...
            | BOOL_IDENTIFIER OPR_BWA_ASSIGNMENT boolean_expression SEMICOLON {
                if ($1 == NULL)
                {
                    yyerror("variable already defined");
                }
            ...
            | CHAR_IDENTIFIER OPR_BWA_ASSIGNMENT arithmetic_expression SEMICOLON {
                if ($1 == NULL)
                {
                    yyerror("variable already defined");
                }
...
bwo_assignment: INT_IDENTIFIER OPR_BWO_ASSIGNMENT arithmetic_expression SEMICOLON {
               if ($1 == NULL)
               {
                   yyerror("variable already defined");
               }
               ...
               $1->data_type = DT_INTEGER;
               $1->value = $1->value | $3->value;
               $$ = create_bwo_assignment_node($1, $3);

               printf("%s := %d\n", $1->identifier, $1->value);
            }
            | BOOL_IDENTIFIER OPR_BWO_ASSIGNMENT boolean_expression SEMICOLON {
                if ($1 == NULL)
                {
                    yyerror("variable already defined");
                }
            ...
            | CHAR_IDENTIFIER OPR_BWO_ASSIGNMENT arithmetic_expression SEMICOLON {
                if ($1 == NULL)
                {
                    yyerror("variable already defined");
                }
