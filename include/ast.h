...
#define AST_NODE_ADD_ASSIGNMENT      5005
...
#define AST_OPR_ADD_ASSIGNMENT 4004 // +=
...
struct ast_node_add_assignment;
...
typedef struct ast_node_add_assignment ast_node_add_assignment;
 ...
 struct ast_node_statements 
{
    ...
    union child_nodes
    {
        ...
        ast_node_add_assignment *add_assignment;
